{if $details_page}
    ...
    <div class="ty-branding-text" id="bt-root-{$bt_pid}">
        <div class="ty-branding-text__actions" style="position:relative; z-index: 1000;">
            ...
            <button type="button" class="ty-btn" id="bt-close-{$bt_pid}" style="display:none;">Закрыть</button>
        </div>
...
{literal}
                ...
                window.__BT__['{/literal}{$bt_pid}{literal}'] = {
                    ...
                    urls: {
                        ...
                        preview_for_product: '{/literal}{"branding_text.preview_for_product"|fn_url}{literal}',
                        ...
                        previewForProduct: '{/literal}{"branding_text.preview_for_product"|fn_url}{literal}'
                    }
                };
{/literal}
            })(Tygh, Tygh.$);
